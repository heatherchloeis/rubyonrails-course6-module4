(function() {
  ...
  angular
  	...
  	TagEditorController.$inject = ["$scope", "$q",
  								                 ...
  								                 "spa-demo.subjects.LinkableTagThing"];
  	function TagEditorController($scope, $q, $state, $stateParams,
  								               Authz, Tag, TagThing, LinkableTagThing) {
  	  var vm=this;
  	  vm.selected_linkables = [];
  	  vm.create = create;
  	  vm.clear  = clear;
  	  vm.remove = remove;
  	  vm.linkTagThings = linkTagThings;
  	  ...
  	  function reload(tagId) {
  	  	...
  	  	vm.linkable_tag_things = LinkableTagThing.query({tag_id:itemId});
  	  ...
  	  function linkTagThings(parentPromise) {
  	  	var promises = [];
  	  	if (parentPromise) {
